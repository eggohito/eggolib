...
public record SendMessageS2CPacket(Map<Identifier, MessagePhase> powersToInvoke) implements FabricPacket {
	...
	private static SendMessageS2CPacket read(PacketByteBuf buf) {
		return new SendMessageS2CPacket(buf.readMap(PacketByteBuf::readIdentifier, valueBuf -> valueBuf.readEnumConstant(MessagePhase.class)));
	}

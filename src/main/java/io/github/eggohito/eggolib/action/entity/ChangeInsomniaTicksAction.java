...
public class ChangeInsomniaTicksAction {
    ...
    public static void action(SerializableData.Instance data, Entity entity) {
        ...
        if (operation == ResourceOperation.ADD) newValue = MathHelper.clamp(originalValue + change, 0, Integer.MAX_VALUE);
        else if (operation == ResourceOperation.SET) newValue = MathHelper.clamp(change, 0, Integer.MAX_VALUE);

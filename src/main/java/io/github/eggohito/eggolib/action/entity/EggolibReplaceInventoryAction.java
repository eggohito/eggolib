...
public class EggolibReplaceInventoryAction {
    ...
    public static void action(SerializableData.Instance data, Entity entity) {
        ...
        switch (inventoryType) {
            case INVENTORY -> EggolibInventoryUtil.replaceInventory(data, entity, null);
            case POWER -> {
                ...
                PowerHolderComponent.KEY.maybeGet(entity).ifPresent(
                    powerHolderComponent -> {
                        ...
                        EggolibInventoryUtil.replaceInventory(data, entity, inventoryPower);
    ...
    public static ActionFactory<Entity> getFactory() {
        return new ActionFactory<>(
            ...
            EggolibReplaceInventoryAction::action
        );
    }

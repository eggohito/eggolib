...
public class EggolibModifyProjectileDamagePower extends ValueModifyingPower {
    ...
    public EggolibModifyProjectileDamagePower(PowerType<?> powerType, LivingEntity livingEntity, Consumer<Entity> selfAction, Consumer<Entity> targetAction, Consumer<Pair<Entity, Entity>> biEntityAction, Predicate<Entity> targetCondition, Predicate<Pair<Entity, Entity>> biEntityCondition, Predicate<Pair<DamageSource, Float>> damageCondition) {
    ...
    public static PowerFactory<?> getFactory() {
        ...
        return new PowerFactory<>(
            Eggolib.identifier("modify_projectile_damage"),
            ...
            data -> (powerType, livingEntity) -> {
                ...
                EggolibModifyProjectileDamagePower empdp = new EggolibModifyProjectileDamagePower(
                    powerType,
                    livingEntity,
                ...
                if (data.isPresent("modifier")) empdp.addModifier(data.getModifier("modifier"));
                if (data.isPresent("modifiers")) {
                    List<EntityAttributeModifier> modifiers = data.get("modifiers");
                    modifiers.forEach(empdp::addModifier);
                }

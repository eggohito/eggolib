...
public class BreakingBlockCondition {
    ...
    public static boolean condition(SerializableData.Instance data, Entity entity) {
        ...
        if (breakingBlockPos == null) return false;

        if (usingEffectiveTool) return playerEntity.canHarvest(playerEntity.world.getBlockState(breakingBlockPos)) && (blockCondition == null || blockCondition.test(new CachedBlockPosition(entity.world, breakingBlockPos, true)));
        else return blockCondition == null || blockCondition.test(new CachedBlockPosition(entity.world, breakingBlockPos, true));
